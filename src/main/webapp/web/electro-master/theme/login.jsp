...
<div class="login-wrap">
    <div class="login-html">
        <c:if test="${messageSignIn != null}">
            <form action="<c:url value="/web/electro-master/theme/login?action=sign-in"/>" method="post" style="height: 670px; display: none">
                </c:if>
                    <form action="<c:url value="/web/electro-master/theme/login?action=sign-in"/>" method="post" style="height: 670px">
