    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                ...
                <li><a href="/orderdetail?action=displayProduct">Sản phẩm</a></li>
                ...
                <li><a href="accessories.jsp">Danh sách tài khoản</a></li>
                <li><a href="/orderdetail?action=">Danh sách hóa đơn</a></li>
            </ul>
            <!-- /NAV -->
        </div>
        <!-- /responsive-nav -->
...
<div class="section" align="center">
    <table border="1" width="1000px" style="text-align: center">
        ...
        <c:forEach items="${infos}" var="b">
            <tr>
                <td>${b.getCustomer().getId()}</td>
                <td>${b.getCustomer().getName()}</td>
                <td>${b.getCustomer().getPhone()}</td>
                <td>${b.getCustomer().getAddress()}</td>
                <td>${b.getCustomer().getEmail()}</td>
                <td>${b.getOrder().getId()}</td>
                <td>${b.getOrder().getDate_order()}</td>
                <td>${b.getOrder().getDate_ship()}</td>
                <td>${b.getOrder().getAddress()}</td>
                <c:if test="${b.getOrder().getStatus() == 1}">
                    <td><h5>Đã thanh toán</h5></td>
                    <td><h5>Đã thanh toán</h5></td>
                </c:if>
                <c:if test="${b.getOrder().getStatus() == 0}">
                    <td><h5>Chưa thanh toán</h5></td>
                    <td><button><a style="text-decoration: none" href="/orderdetail?action=delete&id=${b.getOrder().getId()}">Delete</a></button></td>
                </c:if>
